      ...
      <div>
        <div className="flex flex-col h-screen w-screen">
          <div className="h-75 w-screen bg-gray-200 flex flex-row gap-15 justify-center items-center perspective-normal">
            <div className="h-60 w-75 animate-rotate-border bg-conic/[from_var(--border-angle)] from-stone-300 via-amber-400 to-stone-300 rounded-xl relative hover:rotate-y-360 transform-3d transition-all duration-1000">
              <img
                className="h-58 w-73 top-1 left-1 rounded-xl absolute"
                src={mountain}
              />
            </div>
            <div className="h-60 w-170 animate-rotate-border bg-conic/[from_var(--border-angle)] from-stone-300 via-amber-400 to-stone-300 rounded-xl relative">
              <div className="flex flex-col h-58 w-168 bg-amber-50 rounded-lg gap-5 px-2 absolute top-1 left-1 scale-[0.9] hover:scale-[1.00] transition-all duration-700">
          ...
          <div className="h-104 w-screen bg-gray-200">
            <div className="h-104 w-screen flex flex-row items-end justify-center gap-28">
              <div className="border-10 border-fuchsia-100 rounded-lg bg-stone-300 h-70 w-60 mb-10 relative perspective-normal opacity-60 hover:opacity-100 hover:scale-[1.1] transition-all duration-800">
